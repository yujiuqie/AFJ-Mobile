//
//  AFJSystemLogMessage.m
//  AFJ
//
//  Created by Ryan Olson on 1/25/15.
//  Copyright (c) 2020 AFJ Team. All rights reserved.
//

#import "AFJSystemLogMessage.h"

@implementation AFJSystemLogMessage
...
+ (instancetype)logMessageFromASLMessage:(aslmsg)aslMessage {
    ...
    AFJSystemLogMessage *message = [[self alloc] initWithDate:date sender:sender text:text messageID:identifier];
