...
- (void)geocodeButtonAction:(id)sender {
    ...
    [self.geocoder geocodeAddressString:@"上海市黄浦区外滩" completionHandler:^(NSArray<CLPlacemark *> *_Nullable placemarks, NSError *_Nullable error) {
        ...
        [self.geocoder geocodeAddressString:@"上海市长宁区中山公园" completionHandler:^(NSArray<CLPlacemark *> *_Nullable placemarks, NSError *_Nullable error) {
