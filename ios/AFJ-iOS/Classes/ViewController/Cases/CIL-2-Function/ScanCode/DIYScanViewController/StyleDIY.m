...
+ (LBXScanViewStyle *)qqStyle {
    ...
    //线条上下移动图片
    style.animationImage = [UIImage imageNamed:@"qrcode_scan_light_green" inBundle:resource_bundle compatibleWithTraitCollection:nil];
...
+ (LBXScanViewStyle *)ZhiFuBaoStyle {
    ...
    //线条上下移动图片
    style.animationImage = [UIImage imageNamed:@"qrcode_scan_full_net" inBundle:resource_bundle compatibleWithTraitCollection:nil];
...
+ (LBXScanViewStyle *)weixinStyle {
    ...
    //线条上下移动图片
    style.animationImage = [UIImage imageNamed:@"qrcode_Scan_weixin_Line" inBundle:resource_bundle compatibleWithTraitCollection:nil];
...
+ (LBXScanViewStyle *)recoCropRect {
    ...
    //线条上下移动图片
    style.animationImage = [UIImage imageNamed:@"qrcode_scan_part_net" inBundle:resource_bundle compatibleWithTraitCollection:nil];
