...
+ (MSActiveConfigMutableConfigurationState *)mutableCopyWithZone:(NSZone *)zone {
    ...
    MSActiveConfigConfigurationState *state = [MSActiveConfigConfigurationState mutableCopyWithZone:zone];

    mutableCopy.configurationDictionary = [state.configurationDictionary mutableCopy];
    mutableCopy.formatVersion = state.formatVersion;
    mutableCopy.meta = state.meta;
    mutableCopy.creationDateString = state.creationDateString;
