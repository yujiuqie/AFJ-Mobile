...
- (void)viewDidLoad {
    ...
    {
        AFJCaseItemData *item = [AFJCaseItemData new];
        item.title = @"makeStudentsAndTeachers";
        item.didSelectAction = ^(id data) {
    ...
    {
        AFJCaseItemData *item = [AFJCaseItemData new];
        item.title = @"makeSnackOnOtherThread";
        item.didSelectAction = ^(id data) {
    ...
    {
        AFJCaseItemData *item = [AFJCaseItemData new];
        item.title = @"makeSnackOnOtherThread2";
        item.didSelectAction = ^(id data) {
    ...
    {
        AFJCaseItemData *item = [AFJCaseItemData new];
        item.title = @"delete All CDStudent and Teacher";
        item.didSelectAction = ^(id data) {
    ...
    {
        AFJCaseItemData *item = [AFJCaseItemData new];
        item.title = @"delete All Team, Coach and Player";
        item.didSelectAction = ^(id data) {
