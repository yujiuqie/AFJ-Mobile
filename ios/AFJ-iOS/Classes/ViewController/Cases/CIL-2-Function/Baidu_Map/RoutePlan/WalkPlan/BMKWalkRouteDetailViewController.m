...
@interface BMKWalkRouteDetailViewController () <UITableViewDelegate, UITableViewDataSource>
@end

@implementation BMKWalkRouteDetailViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    BMKWalkRouteLineTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cellID"];
    if (cell == nil) {
        cell = [[BMKWalkRouteLineTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cellID"];
    ...
    if (indexPath.row == 0) {
        ...
        BMKWalkRouteDetailModel *model = ((BMKWalkRouteDetailModel *) self.detailModels[indexPath.row - 1]);
        cell.detailModel = model;
        cell.line.hidden = NO;
    }
