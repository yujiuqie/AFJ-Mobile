...
@interface BMKTransitRouteDetailViewController () <UITableViewDelegate, UITableViewDataSource>
@end

@implementation BMKTransitRouteDetailViewController
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return self.detailModels.count + 2;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    BMKTransitRouteLineTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cellID"];
    if (cell == nil) {
        cell = [[BMKTransitRouteLineTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cellID"];
    ...
    if (indexPath.row == 0) {
        ...
        BMKTransitRouteLineDetailModel *model = ((BMKTransitRouteLineDetailModel *) self.detailModels[indexPath.row - 1]);
        cell.detailModel = model;
        cell.line.hidden = NO;
    }
