...
//    if (isDefaultKeyboard) {
    LGMenuSegView *toolView = [[LGMenuSegView alloc] initWithFrame:CGRectMake(0, 0, SCREENW, 40) TitleArray:@[@"系统键盘", @"数字", @"字母", @"符号"]];
    toolView.delegate = self;
    toolView.backgroundColor = [UIColor whiteColor];
    self.inputAccessoryView = toolView;
    UIView *toplineView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREENW, 0.6)];
...
- (void)addTextFieldInputView {
    ...
    _keyBgBoardView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREENW, KeyboardHeight)];
