...
- (void)pushAnimation:(id <UIViewControllerContextTransitioning>)transitionContext {
    ...
    AFJTransAnimationViewController *fromVC;
    ...
    } else if ([[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey] isKindOfClass:[AFJTransAnimationViewController class]]) {
        fromVC = (AFJTransAnimationViewController *) [transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    }
    //取出转场前后视图控制器上的视图view
...
- (void)popAnimation:(id <UIViewControllerContextTransitioning>)transitionContext {
    ...
    //通过viewControllerForKey取出转场前后的两个控制器，这里toVC就是转场后的VC、fromVC就是转场前的VC
    AFJTransAnimationViewController *toVC;
    ...
    } else if ([[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey] isKindOfClass:[AFJTransAnimationViewController class]]) {
        toVC = (AFJTransAnimationViewController *) [transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    }
