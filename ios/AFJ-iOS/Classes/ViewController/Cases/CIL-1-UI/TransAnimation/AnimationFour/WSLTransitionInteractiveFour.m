//
//  WSLTransitionInteractiveFour.m
//  TransferAnimation
//
...
@implementation WSLTransitionInteractiveFour
...
- (void)handleGesture:(UIPanGestureRecognizer *)panGesture {
    ...
    switch (_interactiveType) {
        case WSLInteractiveFourTypePresent:
            [self doInteractiveTypePresent:panGesture];
            break;
        case WSLInteractiveFourTypeDissmiss:
            [self doInteractiveTypeDissmiss:panGesture];
            break;
        case WSLInteractiveFourTypePush:
            [self doInteractiveTypePush:panGesture];
            break;
        case WSLInteractiveFourTypePop:
