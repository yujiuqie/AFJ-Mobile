...
- (void)viewDidLoad {
    ...
    CGRect minuteSliderFrame = CGRectMake((SCREENW - 310) / 2.0, 170, 310, 310);
    ...
    CGRect hourSliderFrame = CGRectMake((SCREENW - 210) / 2.0, 220, 210, 210);
    ...
    {
        _timeLabel = [[UILabel alloc] initWithFrame:CGRectMake((SCREENW - 200) / 2.0, 500, 200, 180)];
