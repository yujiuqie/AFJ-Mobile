...
- (void)updateUILayout {
    ...
    if (_unlockType == ClickNumberType) {
        ...
        _pswInputView = [[WHC_PswInputView alloc] initWithFrame:CGRectMake(0.0, CGRectGetMaxY(_inputPswLab.frame), self.view.width, KWHC_InputPswLabHeight)];
        ...
        _delBtn = [self createButtonWithFrame:CGRectMake(self.view.width - KWHC_DelBtnWidth * 1.5, CGRectGetMaxY(_numberPlateView.frame), KWHC_DelBtnWidth, KWHC_BottomHeight) txt:KWHC_DelBtnTxt];
        ...
        CGFloat numberPlateViewY = CGRectGetMaxY(_inputPswLab.frame) * 1.5;
