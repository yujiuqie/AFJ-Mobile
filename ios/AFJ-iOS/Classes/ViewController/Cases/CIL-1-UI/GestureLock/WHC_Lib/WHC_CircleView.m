...
- (void)setCircleType:(WHCGestureUnlockType)circleType {
    ...
    if (_circleType == ClickNumberType) {
        ...
        _numBtn.frame = CGRectMake((self.width - KWHC_SolidCircleRaduis * 2.0) / 2.0, (self.height - KWHC_SolidCircleRaduis * 2.0) / 2.0, KWHC_SolidCircleRaduis * 2.0, KWHC_SolidCircleRaduis * 2.0);
