...
extension UIView {
     ...
     */
    func d3_Animation(_ type: CATransitionType, subType: CATransitionSubtype!, duration: TimeInterval) {
    ...
    func d3_Animation(_ duration: TimeInterval, transition: UIView.AnimationTransition, forView: UIView, completion: CompleteBlock) {
    ...
    func d3_flip(_ duration: TimeInterval, completion: CompleteBlock) {
        self.d3_Animation(duration, transition: UIView.AnimationTransition.flipFromLeft, forView: self, completion: completion)
    }
    ...
    func d3_pageing(_ duration: TimeInterval, completion: CompleteBlock) {
        self.d3_Animation(duration, transition: UIView.AnimationTransition.curlUp, forView: self, completion: completion)
    }
