//
//  AFJAnimationBaseViewController.m
//  侧滑菜单
//
...
#import "AFJAnimationBaseViewController.h"

@interface AFJAnimationBaseViewController ()

@property(nonatomic, strong) NSArray *operateTitleArray;

@end

@implementation AFJAnimationBaseViewController
